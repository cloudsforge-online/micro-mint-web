 ...
 * consent on a previous visit. A first-time reader gets nothing until they press Accept in the
 * banner the shell renders last.
 *
 ...
 *
 * Before `bootstrapSession()` for the same ordering reason: that call is awaited and goes over the
 * wire, so priming after it would leave a real network round trip during which the default is not
 * yet denied.
 */
initAnalytics()
