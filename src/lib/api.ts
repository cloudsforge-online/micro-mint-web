 ...
 * `errorReply()` in every service (`hub-api/src/server.ts:682`, `identity/src/server.ts:1512`,
 * `service-template/src/server.ts:372`). This function used to read it as flat, assigning
