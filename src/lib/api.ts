 ...
 * `errorReply()` in every service (`hub-api/src/server.ts:589`, `identity/src/server.ts:1970`,
 * `service-template/src/server.ts:341`). This function used to read it as flat, assigning
